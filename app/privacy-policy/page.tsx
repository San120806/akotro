...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-[#FEFBD8] flex flex-col font-sans text-gray-800">
      <Header />
      ...
      <section className="bg-[#fdd835] py-12 px-4 border-b-2 border-[#fdd835]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-700 font-medium text-sm md:text-base">
            Your privacy and the security of your information are of utmost importance to us.
          </p>
        </div>
      </section>

      {/* Main Content */}
      <main className="flex-grow max-w-4xl mx-auto px-6 py-12 leading-relaxed">
        <div className="bg-white rounded-2xl shadow-md p-8 md:p-12 space-y-8 text-sm md:text-base">
          ...
          <section className="space-y-4 pt-4 border-t border-gray-100">
            <p className="text-xs text-gray-500 uppercase tracking-wider font-bold">
              ANY CAPITALISED WORDS USED HENCEFORTH SHALL HAVE THE MEANING ACCORDED TO THEM UNDER THIS AGREEMENT. FURTHER, ALL HEADINGS USED HEREIN ARE ONLY FOR THE PURPOSE OF ARRANGING THE VARIOUS PROVISIONS OF THE AGREEMENT IN ANY MANNER. NEITHER THE USER NOR THE CREATORS OF THIS PRIVACY POLICY MAY USE THE HEADINGS TO INTERPRET THE PROVISIONS CONTAINED WITHIN IT IN ANY MANNER.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              Providing a username and password will not be applicable to guest checkout. This privacy policy also applies to data we collect from users who are not registered as members of this site, including, but not limited to, browsing behaviours, pages viewed etc.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              <strong>Stage 2: Arbitration.</strong> In case that mediation does not yield a result suitable or preferred by any one of the parties, arbitration may follow, the award of which is binding on both parties. The Arbitration Board shall comprise three members – one appointed by each party and the third member to be nominated by the two appointed members by mutual consent. Arbitration shall be held at Coimbatore, India. The proceedings of arbitration shall be in the English language. The arbitrator’s award shall be final and binding on the Parties. If the dispute cannot be resolved by this two-step Alternate Dispute Resolution mechanism, it shall be referred to the courts at Mumbai, India.
            </p>
          </section>
