...
export default function TeamSection() {
  return (
    <section className="py-0 flex flex-col md:flex-row w-full">
      ...
      <div className="flex-1 bg-[#fdd835]/30 py-16">
        <div className="max-w-3xl mx-auto px-8">
          <p className="text-[#880808] font-bold text-sm mb-2">— ABOUT AKOTRO</p>
          ...
          <div className="space-y-4 mb-8">
            <div className="border-l-4 border-[#fdd835] pl-4 py-2 bg-white rounded">
          ...
          <Link href="/about" className="block w-full">
            <button className="w-full bg-[#6b0606] text-white px-6 py-3 rounded font-medium hover:bg-[#5a0505] text-sm">
              READ OUR FULL STORY →
            </button>
          </Link>
        </div>
      ...
      <div className="w-1 bg-[#fdd835]"></div>

      {/* Right - White Background */}
      <div className="flex-1 bg-white py-16">
        <div className="max-w-3xl mx-auto px-8">
          <p className="text-[#880808] font-bold text-sm mb-2">— MEET THE TEAM</p>
          <h2 className="text-3xl font-bold mb-8">
            <span className="text-black">The People Behind </span><span className="text-[#880808]">Akotro</span>
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg border-2 border-[#fdd835] overflow-hidden flex flex-col">
              ...
              <div className="p-4 flex-1">
                <p className="text-[#880808] font-bold text-xs mb-1">FOUNDER & OWNER</p>
            ...
            <div className="bg-white rounded-lg border-2 border-[#fdd835] overflow-hidden flex flex-col">
              ...
              <div className="p-4 flex-1">
                <p className="text-[#880808] font-bold text-xs mb-1">ECO WARRIOR</p>
