    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-16">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-shrink-0">
              <div className="w-24 h-24 rounded-full bg-[#fdd835] flex items-center justify-center">
                <span className="text-4xl font-bold text-[#880808]">3R</span>
              </div>
            </div>
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold mb-4 text-black">
                Our mission is to <span className="text-[#880808]">change people's spending patterns</span> for their lifestyle commodities — one recycled pen at a time.
              </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Reduce Card */}
          <div className="bg-[#fdd835]/30 p-8 rounded-lg">
            <div className="mb-6">
              <div className="w-12 h-12 rounded-full bg-[#880808] flex items-center justify-center">
            ...
            <h3 className="text-2xl font-bold text-[#880808] mb-3">Reduce</h3>
            <p className="text-black text-sm leading-relaxed">
          ...
          <div className="bg-[#fdd835]/30 p-8 rounded-lg">
            ...
            <h3 className="text-2xl font-bold text-[#880808] mb-3">Reuse</h3>
            <p className="text-black text-sm leading-relaxed">
          ...
          <div className="bg-[#fdd835]/30 p-8 rounded-lg">
            ...
            <h3 className="text-2xl font-bold text-[#880808] mb-3">Recycle</h3>
            <p className="text-black text-sm leading-relaxed">
